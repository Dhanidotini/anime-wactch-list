...
class EpisodePolicy
{
    ...
    {
        return $user->can('force_delete_episodes::episode');
    }
    ...
    {
        return $user->can('force_delete_any_episodes::episode');
    }
    ...
    {
        return $user->can('replicate_episodes::episode');
    }
    ...
    {
        return $user->can('reorder_episodes::episode');
    }
}
